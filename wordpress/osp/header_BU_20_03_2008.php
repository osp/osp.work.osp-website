...
<div id="container">
	...
	<div id="header_img">
		...
		<?php } elseif (is_page()) { ?>
		<img src="<?php bloginfo('template_url'); ?>/images/header_3.jpg" alt="<?php bloginfo('name'); ?> header image 3" title="<?php bloginfo('name'); ?> header image 3" />
		<?php } elseif (is_archive()) { ?>
		<img src="<?php bloginfo('template_url'); ?>/images/header_4.jpg" alt="<?php bloginfo('name'); ?> header image 4" title="<?php bloginfo('name'); ?> header image 4" />
		<?php } else { ?>
		<img src="<?php bloginfo('template_url'); ?>/images/header_5.jpg" alt="<?php bloginfo('name'); ?> header image 5" title="<?php bloginfo('name'); ?> header image 5" />
		<?php } ?>
	</div><!--header_img-->